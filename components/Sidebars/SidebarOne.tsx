...
const SidebarOne = ({isSidebarOpen} : any) => {
    ...
    return (
        <aside className={`fixed bottom-0 z-40 ${isSidebarOpen ? 'left-0' : '-left-full -translate-x-full'} lg:sticky lg:translate-x-0 lg:left-0 w-[250px] h-[calc(100vh-70px)] pt-3 transition-transform bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700`} aria-label="Sidebar">
